// frontend/src/components/GenreSearchModal.jsx
'use client';
      ...
      {open && (
        ...
        >
          <motion.div
            ...
            className={cn(
              'relative w-full max-w-3xl bg-white dark:bg-zinc-900',
              'rounded-t-2xl md:rounded-2xl shadow-2xl border border-zinc-200 dark:border-zinc-700',
              'p-4 sm:p-6 md:p-7'
            )}
